            ...
            425: (e, t, r) => {
                r(55),
                    (e.exports = function (e) {
                        return (
                            "" +
							'<div class="modal fade" id="myModal" tabindex="-1" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Mensagem</h5></div><div class="modal-body"></div><div class="modal-footer"><button class="btn btn-primary" id="close" type="button" data-dismiss="modal">Close</button></div></div></div></div>'
            ...
            152: (e, t, r) => {
                ...
                e.exports = function (e) {
                    ...
                    return (
                        function (e, a) {
                            (r +=
                                '<div class="container-fluid p-l-0 p-r-0" id="uploaderCont"><div class="row ddHandler"><div class="col-12" id="dragandrophandler"><svg class="bi bi-upload" width="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M.5 8a.5.5 0 01.5.5V12a1 1 0 001 1h12a1 1 0 001-1V8.5a.5.5 0 011 0V12a2 2 0 01-2 2H2a2 2 0 01-2-2V8.5A.5.5 0 01.5 8zM5 4.854a.5.5 0 00.707 0L8 2.56l2.293 2.293A.5.5 0 1011 4.146L8.354 1.5a.5.5 0 00-.708 0L5 4.146a.5.5 0 000 .708z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M8 2a.5.5 0 01.5.5v8a.5.5 0 01-1 0v-8A.5.5 0 018 2z" clip-rule="evenodd"></path></svg><span>Arraste aqui ou<label>Clique para buscar <input value="browse" type="file" style="display: none;" multiple></label></span></div></div>\x3c!--.row.fileQueue--\x3e<div class="row queueSrc"><div class="col name"><b></b></div>'),
                                ...
                                e &&
                                    ((r += '<div class="col options"><select class="custom-select custom-select-sm"><option selected>Selecione o tipo do arquivo</option>'),
                                    function () {
                                        var a = e;
                    ...
                    function n(e) {
                        ...
                        for (let r = 0; r < e.length; r++) {
                            if (e[r].size > 1048576 * a.sizeLimit) {
                                const t = `\n                    O tamanho maxímo para cada arquivo é ${a.sizeLimit} MB.\n                    <br><b>${e[r].name}</b> possuí ${(e[r].size / 1048576).toFixed(1)} MB.`,
                                    o = $("#myModal");
                                ...
                                "Remove" == e.currentTarget.attributes.value.nodeValue
                                    ...
                                    ? (function () {
                                          ...
                                          a.selectOpts && ((File.prototype.fileType = ""), o.map((e) => ((e.fileType = n.filter(`:has(input[data-name='${e.name}'])`).find(".col.desc input").val()), e))),
                                              ...
                                              o.forEach((t) => e.append("palp_file", t)),
                                              n.animate({ opacity: 0 }, 400, () => {
                                                  $(".row.ddHandler").css("opacity", 0), $(".row.submit").hide(), $(".row.ulProgress").show();
                                              }),
											  e.append('csrfmiddlewaretoken', $("input[name=csrfmiddlewaretoken]").val()),
											  e.append('tipo', $('.custom-select').val()),
											  e.append('proc', $('#id-proc').val()),
                                              ...
                                              setTimeout(() => {
                                                  ...
                                                  $.ajax({
                                                      ...
                                                      contentType: !1,
                                                      processData: !1,
													  //headers: {'csrftoken': $("input[name=csrfmiddlewaretoken]").val()},
                                                      ...
                                                      success: (e, t, r) => {
                                                          ...
                                                          const i = $("#myModal");
                                                          i.find(".modal-body").text(`Arquivo${1 == o.length ? "" : "s"} enviados com sucesso!`), setTimeout(() => i.modal("show"), 70), a.postFn.call();
